    ...
    <div class="wrap">
        <div class="login_wrap">
            ...
            <div class="join_form">
                ...
                <div class="idbox">
					<input type="text" placeholder="아이디 입력" name="id" value="${id}" id="id" oninput="checkIdOnInput()">
                    <button type="button" onclick="checkId()">중복체크</button>
                </div>
                    <p id="idCheck">*유효성 검사</p>
                    <input type="password" placeholder="비밀번호 입력" name="password" id="pw" oninput="checkPassword()">
                    <input type="password" placeholder="비밀번호 확인" name="passwordconfirm" id="confirmPassword" oninput="checkPassword()">
                    <p id="pwCheck"></p>
                    <input type="text" placeholder="이메일 입력" name="email" value="" id="email" oninput="checkEmail()">
                    <p id="emailCheck"></p>
                    <input type="text" placeholder="이름 입력" name="name" value="" id="membername">
                    <input type="text" placeholder="닉네임 입력" name="nick" value="">
                    <input type="text" placeholder="생년월일 8자리 입력" name="birthday" value="" id="birth" pattern="\d*" maxlength="8" oninput="checkBirthday()">
                    <p id="birthCheck"></p>
                    <input type="text" placeholder="핸드폰 번호 입력" name="tel" value="" id="tel">
...
console.log('${msg}');
    ...
    function checkFormValidity() {
        ...
        if (idValid && pwValid && emailValid && birthValid) {
